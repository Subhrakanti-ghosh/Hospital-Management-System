...
public class DoctorDao {
	...
	public boolean updateDoctor(Doctor d) {
		...
		try {
			String sql = "update doctor set full_name=?,dob=?,qualification=?,specialist=?,email=?,mobno=?,password=? where iddoctor=?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, d.getFullName());
			ps.setString(2, d.getDob());
			ps.setString(3, d.getQualification());
	...
	public boolean checkOldPassword(int userid, String oldPassword) {
		...
		try {
			String sql = "select * from doctor where iddoctor=? and password=?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, userid);
	...
	public boolean changePassword(int userid, String newPassword) {
		...
		try {
			String sql = "update doctor set password=? where iddoctor=?";
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public boolean editDoctorProfile(Doctor d) {
		...
		try {
			String sql = "update doctor set full_name=?,dob=?,qualification=?,specialist=?,email=?,mobno=? where iddoctor=?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, d.getFullName());
			ps.setString(2, d.getDob());
			ps.setString(3, d.getQualification());
